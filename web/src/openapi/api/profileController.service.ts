...
export class ProfileControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public listAllFormsOfMetadata1(
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpResponse<RepresentationModelObject>>;
  public listAllFormsOfMetadata1(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<RepresentationModelObject>>;
  public listAllFormsOfMetadata1(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: {
    ...
    return this.httpClient.request<RepresentationModelObject>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
